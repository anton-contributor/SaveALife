package com.savelife.mvc.service.routing.maps.bing;
...
import com.savelife.mvc.service.routing.maps.MapService;
import com.savelife.mvc.service.routing.maps.Routing;
...
public class BingMapService implements MapService {
    ...
    @Override
    public Routing getRouting(NodeEntity start, NodeEntity end) throws IncorrectRequestCoordinatesException, RoutingServerNotRespondingException {
        String URL = BING_URL +
        ...
        try {
            ...
            throw new IncorrectRequestCoordinatesException("Incorrect coordinates");
